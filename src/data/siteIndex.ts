...
const baseDocs: SiteDoc[] = [
  ...
  { title: 'Certifications', path: '/certifications', category: 'Learn', description: 'Validate your Nexora skills.' },
  ...
  { title: 'Download', path: '/download', category: 'Get the Software', description: 'Get Nexora for your platform.' },
  ...
  { title: 'Translations', path: '/translations', category: 'Collaborate', description: 'Help localize Nexora.' },
  ...
  { title: 'Meet an advisor', path: '/meet-an-advisor', category: 'Get Services', description: 'Book time with a Nexora expert.' },
  ...
  { title: 'All Industries', path: '/industries', category: 'Industries', description: 'Explore Nexora solutions by industry.' },
