    ...
    <div className="data-ecosystem-container">
      ...
      <div className="ecosystem-overlay">
        <div className="eco-indicator">
          <span className="eco-dot"></span> Real-time Sync
        </div>
        <div className="eco-indicator">
          <span className="eco-dot delay-500"></span> Neural Flow
        </div>
      </div>
    </div>
  );
...
const Home: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    requestAnimationFrame(() => {
      ...
      if (frameTime > 32) {
        // Target < 32ms initial frame for high-end
        setIsLowPower(true);
      }
    });
    ...
    const updateInteractions = () => {
      ...
      if (scrolled.current) {
        const scrollPercent =
          (sy / (document.documentElement.scrollHeight - window.innerHeight)) *
          100;
    ...
    const handleMouseEnter = (e: any) => {
      ...
      const isContent =
        e.target.classList.contains("app-card") || e.target.tagName === "IMG";
    ...
    document
      .querySelectorAll("a, button, .app-card, .mock-card")
      .forEach((el) => {
    ...
    const revealObserver = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          const dx = Math.abs(
            mousePosRef.current.x - (rect.left + rect.width / 2),
          );
          const dy = Math.abs(
            mousePosRef.current.y - (rect.top + rect.height / 2),
          );
  ...
  const featuredApps = appModules.filter((app) =>
    featuredAppSlugs.includes(app.slug),
  );

  return (
    <div
      className={`home-container ${isCinematic ? "cinematic-mode" : ""}`}
      ref={containerRef}
    ...
    >
      ...
      <div
        className={`luxury-cursor ${isCursorActive ? "active" : ""}`}
        ref={cursorRef}
      ></div>
              ...
              <div className="mock-grid">
                ...
                <div className="mock-chart-container">
                  ...
                  <svg className="line-chart-svg" viewBox="0 0 400 120">
                    ...
                    <circle
                      className="chart-node node-pulse"
                      cx="100"
                      cy="70"
                    />
        ...
        <div className="container">
          <div className="section-header-lite">
            ...
            <h2>
              ...
              in one simplified suite
            </h2>
            <p>
              Ditch the fragmented apps. Get a unified system that grows with
              you.
            </p>
          </div>
        </div>
            ...
            <div className="apps-grid">
              {featuredApps.map((app, index) => (
                ...
                >
                  ...
                  <h3 className="app-name-label parallax-layer-mid">
                    {app.name}
                  </h3>
                </Link>
              ))}
      ...
      <section className="comparison-section reveal-on-scroll">
        <div className="container">
          <div className="section-header-lite">
            <h2 className="title-handwritten">
              Imagine without Nexora{" "}
              <span className="handwritten-accent alt">fragmented</span>
            </h2>
            <div className="toggle-switch-container">
              <span className={!isIntegrated ? "active-label" : ""}>
                Traditional
              </span>
              <div
                className={`toggle-switch ${isIntegrated ? "on" : ""}`}
                onClick={() => setIsIntegrated(!isIntegrated)}
              >
          ...
          <div
            className={`comparison-content ${isIntegrated ? "integrated" : "fragmented"}`}
          >
            <div className="comparison-card fragmented-view">
              <div className="pain-points">
                <div className="pain-item">
                  <XCircle color="#ff5f57" size={20} /> Manual data reentry
                  between apps
                </div>
                <div className="pain-item">
                  <XCircle color="#ff5f57" size={20} /> Expensive multi-vendor
                  subscriptions
                </div>
                <div className="pain-item">
                  <XCircle color="#ff5f57" size={20} /> Fragmented team
                  workflows
                </div>
                <div className="pain-item">
                  <XCircle color="#ff5f57" size={20} /> Messy API integrations
                  that break
                </div>
              </div>
            ...
            <div className="comparison-card integrated-view">
              <div className="solution-points">
                <div className="solution-item">
                  <CheckCircle2 color="#28c940" size={20} /> Zero manual entry —
                  data flows instantly
                </div>
                <div className="solution-item">
                  <CheckCircle2 color="#28c940" size={20} /> One predictable,
                  affordable price
                </div>
                <div className="solution-item">
                  <CheckCircle2 color="#28c940" size={20} /> Unified UX means
                  zero retraining
                </div>
                <div className="solution-item">
                  <CheckCircle2 color="#28c940" size={20} /> Built-in security &
                  compliance
                </div>
              </div>
        ...
        <div className="container">
          <div className="prop-row">
            <div className="prop-text">
              ...
              <h2>
                Integrated by design, <br />
                not by accident.
              </h2>
              <p>
                When you install a new app, it's already connected to your
                existing data. Accounting talks to Sales. Inventory talks to
                Manufacturing.
              </p>
              <ul className="prop-list">
                <li>
                  <Zap size={18} /> Real-time sync across all modules
                </li>
                <li>
                  <Layers size={18} /> Single source of truth for your data
                </li>
                <li>
                  <ShieldCheck size={18} /> Consistent team experience
                </li>
              </ul>
            </div>
      ...
      <section className="final-cta">
        <div className="container">
          <div className="cta-content-box">
            ...
            <p>
              Join the thousands of companies that switched for a better UX.
            </p>
